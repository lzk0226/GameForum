<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['purchase:balance:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['purchase:balance:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['purchase:balance:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['purchase:balance:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="balanceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="累计消费" align="center" prop="totalConsume" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="累计充值" prop="totalRecharge">
          <el-input v-model="form.totalRecharge" placeholder="请输入累计充值" />
        </el-form-item>
        <el-form-item label="累计消费" prop="totalConsume">
          <el-input v-model="form.totalConsume" placeholder="请输入累计消费" />
        </el-form-item>
      </el-form>
...
<script>
import { listBalance, getBalance, delBalance, addBalance, updateBalance } from "@/api/purchase/balance"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户余额编号为"' + userIds + '"的数据项？').then(function() {
        return delBalance(userIds)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('purchase/balance/export', {
        ...this.queryParams
